...
pub async fn google_sso() -> Result<(), ServerFnError> {
    ...
    leptos::logging::log!("google_sso called!");
...
pub fn SignIn() -> impl IntoView {
    ...
    view! {
      ...
      // <button style="display:flex;"  on:click=move|_| {spawn_local(async {
      //     google_sso().await.unwrap();
      // });}>
      <svg style="width:2rem; display: block;" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" xmlns:xlink="http://www.w3.org/1999/xlink">
